        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            ...
            <p className="leading-relaxed text-lg">
              ...
              taiyaki taxidermy cronut +1 kinfolk. Single-origin coffee ennui
              ...
              gastropub normcore XOXO pickled cindigo jean shorts. Slow-carb
              next level shoindigoitch ethical authentic, yr scenester sriracha
